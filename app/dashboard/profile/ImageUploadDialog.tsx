      ...
      <DialogContent className="sm:max-w-106.25 rounded-3xl">
        ...
        <div className="grid gap-4">
          <div className="flex justify-center my-4">
            <Avatar
              className="size-64 shadow-md border-3 hover:cursor-pointer hover:shadow-2xl hover: transition-all duration-300 hover:scale-105"
              onClick={() => fileInputRef.current?.click()}
            >
              <AvatarImage src={preview || undefined} alt="Profile preview" />
              <AvatarFallback className={cn("text-2xl font-bold")}>
                Logo
              </AvatarFallback>
            </Avatar>
          </div>
